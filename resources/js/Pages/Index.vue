...
<template>
    ...
    <div class="flex justify-center items-center min-h-screen">
        <div class="border border-black p-5 flex flex-col gap-2 w-80" v-if="user">
            ...
            <div class="text-center">
                <button @click="logout" type="button" class="underline cursor-pointer bg-transparent p-0 border-0">Logout</button>
            </div>
        </div>
        <div v-else>
